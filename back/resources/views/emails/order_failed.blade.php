    ...
    <tr>
        <td align="center">
            <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
                <tr>
                    <td style="background:#7f1d1d;color:#ffffff;padding:16px 20px;">
                        <div style="font-size:18px;font-weight:700;">No se pudo completar tu pedido</div>
                        <div style="font-size:12px;color:#fecaca;">Orden #{{ $order->id }}</div>
                    </td>
                </tr>
                <tr>
