    ...
    <tr>
        <td align="center">
            <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
                <tr>
                    <td style="background:#0f766e;color:#ffffff;padding:16px 20px;">
                        <div style="font-size:18px;font-weight:700;">Reembolso procesado</div>
                        <div style="font-size:12px;color:#99f6e4;">Orden #{{ $order->id }}</div>
                    </td>
                </tr>
                <tr>
                    <td style="padding:18px 20px;color:#111827;">
                        ...
                        <p style="margin:0 0 12px 0;color:#4b5563;">
                            Hemos procesado tu reembolso. El tiempo de acreditacion depende de tu banco.
                        </p>
